...
- **Manifest version** chosen: 7.0.4 (matches `collaboration/m365/connector.yaml`; recommended for
  new connectors by `.claude/skills/connector/workflows/create.md` §3.1).
...
- **Convention**: `.claude/skills/connector/workflows/create.md` §3.1 says: "MUST include …
...
- **Workflow expected**: `.claude/skills/connector/workflows/create.md` Phase 1 asks 6
...
- **Where**: `.claude/skills/connector/workflows/create.md` §3.5–3.6 — defines a single
...
- **Where**: `.claude/skills/connector/workflows/create.md` §3.3, last bullet of the K8s
...
- **Where**: `.claude/skills/connector/workflows/validate.md` §"Bronze Promotion" calls
