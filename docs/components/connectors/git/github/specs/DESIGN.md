...
| COMPL-DESIGN-002 -- Privacy Architecture | Not applicable | Code metadata only. GitHub email privacy handling is an identity resolution concern handled at Silver Step 2, not a compliance architecture concern. |
