...
- `keycloak` imports the generated roster realm (`insight-seed-realm`,
  generated by conftest.py into `./keycloak-import`); the login helper drives
  its real HTML login form.
...
The suite builds the analytics / identity-resolution / authenticator / gateway
